"""
LLaVA-1.6-Vicuna-7B (LLaVA-NeXT) model wrapper using HuggingFace transformers.
...
LLAVA_1_6_VICUNA_7B = "llava-hf/llava-v1.6-vicuna-7b-hf"


class LlavaVicunaModel(BaseModel):
    """
    LLaVA-v1.6 (LLaVA-NeXT) wrapper for Vicuna 7B backend.
    """

    def __init__(
        self,
        model_name: str = LLAVA_1_6_VICUNA_7B,
    ...
    def load(self) -> None:
        """Load LLaVA-1.6-Vicuna model and processor onto GPU."""
        ...
        logger.info(f"Loading LLaVA-1.6-Vicuna model: {self.model_name}")
        ...
        logger.info(f"LLaVA-1.6-Vicuna loaded. model={self.model_name}, device={device_map}, dtype={self.dtype}")
